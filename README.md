...
Replace `0.3.0` with the latest tag.
...
plugins {
    ...
    id("io.ssemaj.deviceintelligence") version "0.3.0"
}
```
...
dependencies {
    implementation("com.github.iamjosephmj.DeviceIntelligence:deviceintelligence:0.3.0")
}
```
